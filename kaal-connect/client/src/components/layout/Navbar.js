...
const KALALogo = () => (
  <Link to="/" className="flex items-center gap-3 group">
    ...
    <div className="flex flex-col leading-none">
      <span className="font-display text-parchment-50 text-lg font-semibold tracking-tight">KALA</span>
      ...
      <div className="page-container">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center gap-8">
             ...
             <Link to="/contact" className="nav-link">Contact</Link>         {user && !isSeller && (
              <>
      ...
      {mobileOpen && (
        <div className="md:hidden bg-ink-900/98 border-t border-ink-700 backdrop-blur-sm animate-fade-in">
          <div className="page-container py-4 flex flex-col gap-1">
            ...
            <Link to="/about" className="px-4 py-3 text-purple-700 hover:text-blue-400 font-sans text-sm border-b border-purple-100">About</Link>
            <Link to="/contact" className="px-4 py-3 text-purple-700 hover:text-blue-400 font-sans text-sm border-b border-purple-100">Contact</Link>
            {user && !isSeller && (
              <>
